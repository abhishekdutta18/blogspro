...
async function testBackend() {
    ...
    try {
        const res = await get("https://blogspro-upstox.abhishek-dutta1996.workers.dev/quotes");
    ...
    try {
        const res = await get("https://blogspro-upstox.abhishek-dutta1996.workers.dev/global");
        const json = JSON.parse(res.data);
        if (json.status === "success") {
