...
| Author + admin account + mobile editor stability | Codex | DONE | `admin.html`, `index.html`, `post.html`, `css/admin.css`, `js/posts.js`, `js/auth.js`, `js/state.js`, `js/nav.js`, `js/main.js`, `js/admin-account.js`, `js/editor.js` | 2026-03-21 | Added author fields/display, admin account view, and mobile writing reliability fixes. |
