...
(function () {
  ...
  window.addEventListener(
    "scroll",
    function () {
      // ⚡ Bolt Optimization: Use requestAnimationFrame and `{ passive: true }` to
      // throttle DOM reads/writes during scroll, preventing layout thrashing
      // and freeing the main thread.
      if (!isTicking) {
