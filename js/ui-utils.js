...
(function () {
  ...
  window.addEventListener(
    ...
    function () {
      if (!isScrolling) {
        // ⚡ Bolt optimization: Use requestAnimationFrame and ticking flag to prevent layout thrashing on scroll.
        // Also configured with { passive: true } to avoid blocking the main thread.
