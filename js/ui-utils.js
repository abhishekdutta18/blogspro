...
(function () {
  ...
  // ⚡ Bolt: Optimize scroll progress logic to prevent layout thrashing
  // Using requestAnimationFrame to throttle execution to match browser refresh rate
  // and { passive: true } to prevent scroll blocking.
