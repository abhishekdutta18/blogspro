...
(function () {
  ...
  // Optimization: Wrap scroll logic in requestAnimationFrame with a ticking flag
  // to avoid layout thrashing and synchronous main-thread blocks.
  // Added { passive: true } so the browser doesn't wait for preventDefault().
  let ticking = false;
