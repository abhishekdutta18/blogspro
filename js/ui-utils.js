...
(function () {
  ...
  // Optimization: Prevent layout thrashing by reading layout properties and writing
  // to the DOM inside requestAnimationFrame instead of synchronously on scroll.
  let isTicking = false;
