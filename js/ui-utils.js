...
(function () {
  ...
  // ⚡ Bolt Optimization: Wrap scroll calculations in requestAnimationFrame
  // and use a ticking flag to prevent layout thrashing and synchronize DOM
  // updates with the browser's rendering cycle.
  let ticking = false;
