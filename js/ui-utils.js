...
(function () {
  ...
  window.addEventListener(
    ...
    function () {
      if (!isTicking) {
        window.requestAnimationFrame(function () {
          // ⚡ Bolt optimization: Wrapped synchronous DOM reads/writes in requestAnimationFrame
          // to prevent layout thrashing and main thread blocking on scroll events.
    ...
    { passive: true },
  ); // ⚡ Bolt optimization: passive true prevents main thread blocking
