...
(function () {
  ...
  // ⚡ Bolt: Optimized scroll event listener by wrapping it in `requestAnimationFrame`
  // with a ticking flag to throttle updates and prevent main thread blocking.
  // Also added `{ passive: true }` to allow the browser to optimize scrolling.
  let ticking = false;
