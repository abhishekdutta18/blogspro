...
(function () {
  ...
  // ⚡ Bolt Optimization: Wrap scroll logic in requestAnimationFrame
  // and use passive: true to prevent synchronous layout thrashing
  // and keep scrolling 60fps smooth.
  let isTicking = false;
