...
(function () {
  ...
  // ⚡ Bolt: Optimize scroll listener with requestAnimationFrame and passive flag
  // Why: Synchronous scroll events reading layout properties cause main thread blocking and layout thrashing.
