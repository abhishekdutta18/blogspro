...
(function () {
  ...
  // ⚡ Bolt Optimization: Wrap scroll event in requestAnimationFrame to prevent layout thrashing
  // Reduces main thread blocking by throttling updates to the display refresh rate (usually 60fps).
  // The `{ passive: true }` flag allows the browser to scroll smoothly without waiting for JS execution.
  let ticking = false;
