...
// api/upstox-worker.js
var _usdinrCache = 92.7;
var CORS_HEADERS = {
  "Access-Control-Allow-Origin": "*",
  "Access-Control-Allow-Methods": "GET, OPTIONS",
  "Access-Control-Allow-Headers": "Content-Type, Authorization"
};
var UPSTOX_V2 = "https://api.upstox.com/v2";
var UPSTOX_V3 = "https://api.upstox.com/v3";
...
__name(fetchUpstox, "fetchUpstox");
  ...
  async fetch(request, env) {
    try {
      ...
      if (url.pathname === "/quotes") {
        ...
        const fetchYfChart = /* @__PURE__ */ __name(async ([ticker, instrKey]) => {
        ...
        if (usdinr > 0) {
          const conversionMap = {
            "MCX_FO:MCX Gold": /* @__PURE__ */ __name((p) => p * usdinr * 10 / 31.1035, "MCX_FO:MCX Gold"),
            "MCX_FO:MCX Silver": /* @__PURE__ */ __name((p) => p * usdinr * 1e3 / 31.1035, "MCX_FO:MCX Silver"),
            "MCX_FO:Crude Oil": /* @__PURE__ */ __name((p) => p * usdinr, "MCX_FO:Crude Oil"),
            "MCX_FO:Brent Crude": /* @__PURE__ */ __name((p) => p * usdinr, "MCX_FO:Brent Crude"),
            "MCX_FO:Natural Gas": /* @__PURE__ */ __name((p) => p * usdinr, "MCX_FO:Natural Gas"),
            "MCX_FO:Copper": /* @__PURE__ */ __name((p) => p * usdinr / 0.453592, "MCX_FO:Copper"),
            "MCX_FO:Platinum": /* @__PURE__ */ __name((p) => p * usdinr, "MCX_FO:Platinum"),
            "MCX_FO:Palladium": /* @__PURE__ */ __name((p) => p * usdinr, "MCX_FO:Palladium")
          };
          for (const [key, fn] of Object.entries(conversionMap)) {
            if (!merged[key]) continue;
            const safeConv = /* @__PURE__ */ __name((v) => {
              const n = Number(v);
      ...
      if (url.pathname === "/historical") {
        ...
        const fromDate = url.searchParams.get("fromDate") || new Date(Date.now() - 30 * 864e5).toISOString().split("T")[0];
      ...
      if (url.pathname === "/calendar") {
        const extractHighImpact = /* @__PURE__ */ __name((xml) => {
          const events = [...xml.matchAll(/<event>([\s\S]*?)<\/event>/gi)].map((m) => {
            const body = m[1] || "";
            const pick = /* @__PURE__ */ __name((tag) => {
          ...
          return events.filter((e) => e.title && e.country && String(e.impact || "").toLowerCase().includes("high")).slice(0, 10);
        }, "extractHighImpact");
        try {
        ...
        try {
          ...
          const events = (Array.isArray(raw) ? raw : []).filter((e) => e && e.Event && e.Country && Number(e.Importance || 0) >= 2).slice(0, 10).map((e) => ({
            title: e.Event,
            country: e.Country,
            impact: "High",
            date: e.Date,
        ...
        const now = Date.now();
        const inHours = /* @__PURE__ */ __name((h) => new Date(now + h * 3600 * 1e3).toISOString(), "inHours");
      ...
      if (url.pathname === "/calendar-india") {
        const indiaHistoricalSeed = (() => {
          const mk = /* @__PURE__ */ __name((title, monthsAgo, actual, forecast, previous, impact = "High") => {
        ...
        const sortByDate = /* @__PURE__ */ __name((items) => items.sort((a, b) => new Date(a.date || 0).getTime() - new Date(b.date || 0).getTime()), "sortByDate");
        try {
          const te = await fetch("https://api.tradingeconomics.com/calendar?c=guest:guest&f=json");
          if (!te.ok) throw new Error(`TradingEconomics HTTP ${te.status}`);
          const raw = await te.json();
          const live = (Array.isArray(raw) ? raw : []).filter((e) => e && e.Event && e.Country && String(e.Country).toLowerCase().includes("india")).map((e) => ({
            title: e.Event,
            country: "IND",
          ...
          const events2 = sortByDate([...indiaHistoricalSeed, ...live]).slice(-300);
          if (events2.length) {
            return jsonResponse({ status: "success", source: "tradingeconomics-india", events: events2 }, 200, { "Cache-Control": "public, max-age=300" });
          }
        } catch (_) {
        }
...
export {
  upstox_worker_default as default
};
//# sourceMappingURL=upstox-worker.js.map
